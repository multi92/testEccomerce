        ...
        <div class="content-page">
            ...
            <div class="row noMargin">
                ...
                <div class="col-xs-12 _col-xs-100 checkout-confirmation-info-box">
                    ...
                    <?php }?>
                    <?php if($documentData->documentdetail['deliverytype']=='d' && $documentData->documentdetail['deliveryserviceid']>0 && count($documentData->documentdetail['deliverysewrvicedata'])>0){ ?>
                     <h4 class="title"><?php echo $language["shopcart_checkout"][4]; //Način dostave ?> - <?php echo $language["shopcart_checkout"][6]; //Kurirskom službom?></h4>
                        ...
                        <div class="my-label-holder">
                            <label class="checkout-confirmation-my-label">
                                <span class="static"><?php echo $language["shopcart_checkout_delivery_service_table"][1]; //Kurirska služba ?>:</span> <span class="dinamic"><?php echo $documentData->documentdetail['deliverysewrvicedata']['name']; ?></span>
                            </label>
                            <label class="checkout-confirmation-my-label">
                                <span class="static"><?php echo $language["shopcart_checkout_delivery_service_table"][2]; //Telefon ?>:</span> <span class="dinamic"><?php echo $documentData->documentdetail['deliverysewrvicedata']['phone']; ?></span>
                            </label>
                            <label class="checkout-confirmation-my-label">
                                <span class="static"><?php echo $language["shopcart_checkout_delivery_service_table"][3]; //Email ?>:</span> <span class="dinamic"><?php echo $documentData->documentdetail['deliverysewrvicedata']['email']; ?></span>
                            </label>
                            <label class="checkout-confirmation-my-label">
                                <span class="static"><?php echo $language["shopcart_checkout_delivery_service_table"][4]; //Web sajt ?>:</span> <span class="dinamic"><?php echo $documentData->documentdetail['deliverysewrvicedata']['website']; ?></span>
                            </label>
                        </div>
