                ...
                <div class="col-sm-9 col-sm-push-3 col-seter">
                        ...
                        <div class="row">
                            <div class="checkout-form clearfix">
                                ...
                                <div class="col-xs-6 _col-xs-100">
                                    <label class="my-label">
                                        <?php echo $language["shopcart_checkout_customer"][23]; //Vaučer ?>
                                        <input type="text" name="customerVoucher" class="field"
                                                           placeholder="<?php echo $language["shopcart_checkout_customer"][23]; //Postanski broj ?>" 
