        ...
        <div class="row noMargin">
            ...
            <div class="col-sm-6 sve-korpa col-seter">
                ...
                <?php $delivery_cost=0; 
					...
					$_SESSION['order']['delivery']['deliverycost'] = $delivery_cost;
                    if($delivery_cost>0){?>
                    ...
                    <!-- FINISH OR CONTINUE ORDER -->
							<div class="row">
								<div class="col-sm-12">
									<?php if(isset($_SESSION['order']['paymenttype']) && $_SESSION['order']['paymenttype'] == 'k'){ ?>
										<div class="g-recaptcha pull-left" data-sitekey="6LfNp6gUAAAAACtN6PTt-ky28Aky63d3V2ydlN5m"></div>		
									<?php }	else { ?>
                        ...
                        <?php if(($total_price_pdv+$delivery_cost)>=$user_conf["minimal_order_limit"][1] || ((!isset($_SESSION['shopcart']) || count($_SESSION['shopcart'])==0) && (isset($_SESSION['shopcart_request']) || count($_SESSION['shopcart_request'])>0)) ) { ?>
                            ...
                            <a href="checkout_finished" class="sa-button  -rounded -success _half-width cms_order-to-reservation fin-btn" ><?php echo $language["shopcart"][13]; //Završi kupovinu ?></a>
                        <?php } else { ?>
