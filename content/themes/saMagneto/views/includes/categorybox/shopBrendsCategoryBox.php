                        ...
                        <a href="<?php echo rawurlencode($sval['urlname']).$selectedbd;?>">
							...
							<?php if(is_array($sval['image'])) $catimg = $sval['image'][1]; ?>
								<div class="categories-pic">
									<img src="<?php echo GlobalHelper::getImage(rawurldecode($catimg), 'small'); ?>" alt="<?php echo $sval['name'];?>" class="img-responsive">
								</div>
