...
foreach($attrdata as $k=>$v){
	...
	if(isset($v) && $v!=NULL){
		...
		<div class="panel-group atributi" id="accordionMobileATRF<?php echo $j;?>" role="tablist" aria-multiselectable="true">
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingOneMobileATRF">
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" data-parent="#accordionMobileATRF<?php echo $j;?>" href="#collapseMobileATRF<?php echo $j;?>" aria-expanded="<?php echo $colapsed; ?>" aria-controls="collapseMobileATRF<?php echo $j;?>">
							<?php echo $k; ?> <i class="fa fa-angle-down go-right" aria-hidden="true"></i>
						</a>
					</h4>
				</div>
				<div id="collapseMobileATRF<?php echo $j;?>" class="panel-collapse in <?php echo $colapse; ?>" role="tabpanel" aria-labelledby="headingOneMobileATRF" aria-expanded="<?php echo $colapsed; ?>" >
					<div class="panel-body">
						...
						if ($vv['mi'] != '' || $vv['mc'] != ''){ 
							...
							<input type="checkbox" name="checkboxMobileATRF<?php echo $j."I".$n;?>" id="checkboxMobileATRF<?php echo $j."I".$n;?>" class="css-checkbox core_attrSelectValueCheckbox <?php echo $check;?>"   <?php echo $ch; ?> attrvalid="<?php echo $vv['avid']; ?>" value="<?php echo $n; ?>"/>
							<label for="checkboxMobileATRF<?php echo $j."I".$n;?>" class="css-label x-filter-white"><?php echo $vv['avvalue']; ?></label>
