<!-- LOAD FOOTER -->
<?php include("app/controller/core/controller_footer.php"); ?>

<!-- LOAD MODALS -->
<?php include("app/controller/controller_modals.php");?>
<!-- LOAD MODALS -->
<!-- jQuery  -->
...
<!-- PLUGINS JS LOAD -->
<?php include($system_conf["theme_path"][1]."config/plugins_js.php");?>
...
<script src="<?php echo $system_conf["theme_path"][1];?>cdn/js/main.js?<?php echo microtime(true);?>"></script>
</body>
