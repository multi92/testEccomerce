...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	foreach ($orderItems as $key => $orderItem) {
		...
		$email_msg.='	<td style="'.$tableDataStyle.'">NAPOMENA: Ovaj proizvod je na upit i neće se tretirati kao naručen.</td>';
		$email_msg.="</tr>";
	}
	$email_msg.="</tbody>";
	//SET TABLE BODY END
	...
	$email_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='".$picture_on_off_colspan."'>Uskoro ćete biti kontaktirani u vezi sa vašim upitom.</td>";
	$email_msg.="	</tr>";
	$email_msg.="</tfoot>";
