...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	$email_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='".$picture_on_off_colspan."'>Ukupno: </td>";
	...
	$email_msg.="	</tr>";
	$email_msg.="	<tr style='' class='summaryRow nobackground' style=\"border:none; background-color:transparent; \" >";
	$email_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='".$picture_on_off_colspan."'>Popust: </td>";
	...
	$email_msg.="	</tr>";
	$email_msg.="	<tr style='' class='summaryRow nobackground' style=\"border:none; background-color:transparent; \" >";
	$email_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='".$picture_on_off_colspan."'>Ukupno sa popustom bez PDV-a: </td>";
	...
	$email_msg.="	</tr>";
	$email_msg.="	<tr style='' class='summaryRow nobackground' style=\"border:none; background-color:transparent; \" >";
	$email_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='".$picture_on_off_colspan."'>PDV: </td>";
	...
	$email_msg.="		<td style='text-align:right; font-weight:bold; font-size:12px; color: #249212; border:none !important;'>".number_format($calc_totalValueWithRebateWithVat, 2)." ".$language['moneta'][1]."</td>";
	$email_msg.="	</tr>";
	$email_msg.="</tfoot>";
	...
	//SET TABLE DATA END
	//SET FOOTER DATA
	//$email_msg.='<p style="width:100%; text-align:center;">Poštovani, ovo je samo potvrda o uspešno izvršenoj narudžbini proizvoda. Molimo Vas da sačekate zvanični predračun koji ćemo Vam poslati na mail. Postoji mogućnost odstupanja cene o čemu ćete biti obavešteni.</p>';
	//SET FOOTER DATA END
	$email_msg.="</body>";
	$email_msg.="</html>";
?>