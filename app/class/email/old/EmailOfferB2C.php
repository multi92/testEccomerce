...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	$email_msg.="		<th style=\"".$tableHeaderStyle."\">Opis</th>";
	...
	foreach ($orderItems as $key => $orderItem) {
		...
		$email_msg.='	<td style="'.$tableDataStyle.'">'.$orderItem["description"].'</td>';
	...
	//SET TABLE DATA END
	//SET FOOTER DATA
	if((isset($_SESSION['offer']['paymenttype']) && $_SESSION['offer']['paymenttype']=='u') || (isset($documentData->payment) && $documentData->payment == 'u')){ 
