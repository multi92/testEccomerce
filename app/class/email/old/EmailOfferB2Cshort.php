...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	$tableDataStyleDesc = "padding-left: 1mm; vertical-align: middle; 	padding-right: 1mm; padding-top: 1mm; padding-bottom: 1mm; text-align:right; font-family: \'Arial\'; font-size:11px !important;	line-height:12px; border-left:1px solid #333 !important; border-right:1px solid #333 !important;  align-items: center; justify-content: center;";
	foreach ($orderItems as $key => $orderItem) {
		...
		if($user_conf["show_product_picture_in_order_email"][1]=='1'){
    		...
    		height: auto; max-height:100%;border:1px solid red;" src="'.BASE_URL.GlobalHelper::getImage('fajlovi/product/'.$orderItem["picture"], 'thumb').'"/></td>';
		}
		...
		$email_msg.='	<td style="'.$tableDataStyle.'"><p >'.$orderItem["description"].'</p></td>';
