...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	$pdf_msg.="		<th style=\"".$tableHeaderStyle."\">Opis</th>";
	...
	foreach ($orderItems as $key => $orderItem) {
		...
		$pdf_msg.='	<td style="'.$tableDataStyle.'">'.$orderItem["description"].' x </td>';
		$pdf_msg.='	<td style="'.$tableDataStyle.'">'.$orderItem["quantity"].' x </td>';
		$pdf_msg.='	<td style="'.$tableDataStyle.'">'.number_format($orderItem["pricewithrebate"]*(1+($orderItem["taxvalue"]/100)),2).' '.$language['moneta'][1].'</td>';
	...
	//$pdf_msg.="	</tr>";
	//$pdf_msg.="	<tr style='' class='summaryRow nobackground' style=\"border:none; background-color:transparent; \" >";
	//$pdf_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='9'>Ukupno sa popustom bez PDV-a: </td>";
	...
	//$pdf_msg.="	</tr>";
	//$pdf_msg.="	<tr style='' class='summaryRow nobackground' style=\"border:none; background-color:transparent; \" >";
	//$pdf_msg.="		<td style='text-align:right;  font-size:10px; border:none !important;' colspan='9'>PDV: </td>";
