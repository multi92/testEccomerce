...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	$pdf_msg.="<div class='half' style=\"width:50%; float:left; font-size:12px !important; line-height:14px;\">
					".$orderDetailData." ".$emailOrderRecipientData."
				</div>
	...
	//SET TABLE BODY END
	//SET TABLE FOOTER
	$pdf_msg.="<tfoot style='border: 1px solid #333;'>";
	...
	if($voucher_value > 0){
		$pdf_msg.="	<tr style='' class='summaryRow nobackground' style=\"border:1px solid #333; background-color:transparent; \" >";
		$pdf_msg.="		<td style='text-align:right;  font-size:12px; border-right: 1px solid #333 !important;' colspan='6'>Iznos vaučera: </td>";
		$pdf_msg.="		<td style='text-align:right;  font-size:12px; border:none !important;'>- ".number_format($voucher_value, 2)." </td>";
		$pdf_msg.="	</tr>";
	}	
