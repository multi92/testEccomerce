...
//$user_conf MUST BE INCLUDED BEFORE INCLUDING THIS PAGE 
	...
	foreach ($orderItems as $key => $orderItem) {
		...
		if($user_conf["show_product_picture_in_order_pdf"][1]=='1'){
			...
			$pdf_msg.='	<td style="'.$tableDataStyle.'"><img  src="'.BASE_URL.GlobalHelper::getImage('fajlovi/product/'.$orderItem["picture"], 'thumb').'"/></td>';
		}
	...
	$pdf_msg.="		<td style='text-align:right; font-weight:bold; font-size:12px; color: #249212; border:none !important;'>".number_format($calc_totalValueWithRebateWithVat, 2)." ".$language['moneta'][1]."</td>";
	$pdf_msg.="	</tr>";
	$pdf_msg.="</tfoot>";
