<?php
	...
	$topproducts = Category::getCategoryProductDetail($edd_ids,1,16,'','ASC','random', false ,'','',1);
	//$prolist, $page, $itemsperpage , $search, $sort , $sortby,  $action = false, $minprice = '', $maxprice = '', $viewtype = 0
	/* TOP PRODUCTS END */
	
	include($system_conf["theme_path"][1]."views/includes/slider/topProductSlider.php");
?>