<?php //DEVELOPER MODE
$controller_version["categories_news"] = array('controller', '1.0.0.0.1', 'SYSTEM THEME CONTROLLER MUST HAVE DEFINED VALUE FOR "$theme_conf["show_news_all_newscategory"]"" AND "$theme_conf["news_per_page"][1]" PARAMMETERS','app/controller/controller_categories_news.php');
?>
<?php
