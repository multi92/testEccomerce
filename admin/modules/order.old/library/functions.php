<?php
	...
	function change_status(){
		...
		if($_POST['id'] != "")
		{
			$query = "UPDATE `documentb2c` SET `status`='".$_POST['status']."' WHERE id = ".$_POST['id'];	
	...
	function get_item(){
		...
		WHERE d.id=".$_POST['id'];
			...
			$q = "SELECT di.*,
				  ...
				  FROM documentitemb2c AS di
				  LEFT JOIN documentitemattrb2c AS dia ON di.ID=dia.documentitemid 
