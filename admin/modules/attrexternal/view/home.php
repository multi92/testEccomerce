 <div class="content-wrapper" currentview='home'>
 	<section class="content-header -breadcrumbColor">
 		<h1>
 			<i class="fa fa-cogs"></i> Učitani atributi
 		</h1>
 		<ol class="breadcrumb">
 			<li><a href="dashboard"><i class="fa fa-dashboard"></i> Početna </a></li>
 			<li class="active"><i class="fa fa-cogs"></i> Učitani atributi </li>
 		</ol>
 	</section>
 	<!-- Main content -->
             ...
             <div class="col-xs-12">
               ...
               <div class="box">
                 <div class="box-header">
                   <h3 class="box-title">Lista svih učitanih atributa u bazi</h3>
                   <div class="row">
                    	<div class="col-sm-1">
                           <div class="checkbox">
                                <label>Povezani</label>
                                <select class="jq_connectedAttrSearchCont form-control">
                 ...
                 <div class="box-body">
                 	 <table id="listtable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Redni broj</th>
                                <th>Učitani atribut</th>
                                <th>Lokalni atribut</th>
