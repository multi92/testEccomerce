	...
	$("#listtable").DataTable({
        ...
        "ajax":{
                ...
                error: function(){  // error handling
                    ...
                    $("#example1").append('<tbody class="employee-grid-error"><tr><th colspan="3">Nema brendova u bazi</th></tr></tbody>');
        ...
        "language": {
           		"emptyTable":     "Nema unetih podataka",
				"info":           "Prikaz _START_ do _END_ od _TOTAL_ brendova",
				"infoEmpty":      "Prikaz 0 do 0 od 0 brendova",
				"infoFiltered":   "(filtrirano od _MAX_ brendova)",
				"infoPostFix":    "",
				"thousands":      ",",
				"lengthMenu":     "Prikazi _MENU_ brendova",
