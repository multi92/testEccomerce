...
PRIHVAĆENA I POSLATA , KAO I BROJ ZA PRAĆENJE VAŠE PORUDŽBINE .</p>';
		...
		if($type == 5){
			...
			if($info['country'] == 'RSD') {
				$a = '<a href="http://www.bex.rs/onlinepracenjeposiljke.php" target="_blank" >Bex portala</a>';
			}else{
			...
			$smallmessage = '<p class="infoemail_text">
								...
								<p class="infoemail_text">Vaša porudžbina je dostavljena kurirskoj službi Bex!</p>
		...
		$data = '<div class="container">
				...
				<div class="container">
					<h1 class="bigmessage">'.$bigmessage.'</h1>	
					'.$smallmessage.'		
				</div>';
		...
		$mail->Body = "<html>
				<head>
					<style>
						...
						.bigmessage{text-align:center;margin:70px 10px;font-size:65px;line-height:80px;font-family:'Open Sans',Arial,sans-serif;color:#343434;letter-spacing:8px}
