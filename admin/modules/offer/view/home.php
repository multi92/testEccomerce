    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12 verticalMargin10">
				...
				<!-- <button class="btn btn-primary" id="orderButton">Brza porudžbina</button> -->
            </div>
        </div>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Lista svih ponuda u bazi</h3>
                </div><!-- /.box-header -->
      <div class="box-body table-responsive">
					<div class="row">
						...
						<div class="col-sm-6 hide">
							<p>TRENUTNO OČEKIVANI OTKUP PO SVIM POSLATIM A NEPLAĆENIM PONUDAMA JE : <span><b class="jq_totalSentValue"></b></span></p>
						</div>
					</div>
