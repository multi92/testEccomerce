<?php
	 ...
	 * you want to insert a non-database field (for example a counter or static image)
	 ...
	 kolone za WHERE
	 */
	$aColumns = array(  'id', 'title', 'adddate', 'changedate', 'status' );
	...
	$sQuery = "	
		SELECT SQL_CALC_FOUND_ROWS n.id, n.title, n.adddate, n.changedate, n.status, CONCAT(u.name,' ',u.surname) as owner
		FROM  news as n
