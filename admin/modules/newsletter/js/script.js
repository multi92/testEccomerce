...
$(document).ready(function (e) {
	$("#listtable").DataTable({
        ...
        "language": {
				...
				"info":           "Prikaz _START_ do _END_ od _TOTAL_ adresa",
				"infoEmpty":      "Prikaz 0 do 0 od 0 adresa",
				"infoFiltered":   "(filtrirano od _MAX_ adresa)",
				"infoPostFix":    "",
				"thousands":      ",",
				"lengthMenu":     "Prikazi _MENU_ adresa",
