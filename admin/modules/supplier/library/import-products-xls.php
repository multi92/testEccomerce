...
{
	if(file_exists($_SERVER['DOCUMENT_ROOT']."/admin/modules/supplier/import/".$_FILES["importfile"]["name"])) unlink($_SERVER['DOCUMENT_ROOT']."/admin/modules/supplier/import/".$_FILES["importfile"]["name"]);
