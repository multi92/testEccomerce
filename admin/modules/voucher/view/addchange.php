                     ...
                     <div class="box-body">
						 ...
						 <div class="row verticalMargin30">
							<div class="col-sm-6 ">
								...
								<div class="form-group voucherTypeWCont" >
									<label>Tip vaučera</label>
									<select   class="form-control voucherTypeWInput" disabled="disabled" >
										<option value="w">Welcome vaučer</option>
									    <option value="hp">Happy Birthday vaučer</option>
									    <option value="s">Standardni</option>
									</select>
									
								</div>
								<div class="form-group voucherTypeDiscountCont">
									<label>Tip popusta</label>
									<select   class="form-control voucherTypeDiscountInput" >
								...
								<div class="form-group voucherValue">
									<label>Vrednost vaucera</label>
									<input type="number" class="form-control voucherValueInput" placeholder="Vrednost vaucera">
								</div>
								
								<!--<div class="form-group">
									<label>Tip popusta</label>
									<input type="text" class="form-control voucherType" placeholder="Tip popusta" disabled="disabled">
								</div>
								--->
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select   class="form-control voucherApplyOnProductWithRebateInput" >
								...
								<div class="form-group">
									<label>Primenjuje se na određenu vrednost korpe</label>
									<select   class="form-control voucherApplyOnShopCartTottalInput" >
										<option value="y">Da</option>
										<option value="n">Ne</option>
									</select>
								...
								<div class="form-group">
									<label>Vrednost korpe na koju se primenjuje</label>
									<input type="number" class="form-control voucherApplyOnShopCartTottalValueInput" placeholder="Vrednost korpe">
								</div>
								<div class="form-group">
									<label>Slika</label>
									<input type="text" class="form-control voucherImageInput" placeholder="Putanja do slike" >
								</div>
								<div class="form-group">
									<label>Magacin</label>
                     ...
                     <div class="box-body voucher_category hide">
                     	...
                     	<div class="row " style="background: rgb(248, 255, 208); margin-right: 0px;  margin-left: 0px;">
										...
										<option value="0">---</option>
												<?php
													function get_all_deepest_cat($parid, $string)
													{
														global $conn;
														$tmpstring = $string;
														$query = "SELECT * FROM category AS c WHERE c.parentid = ".$parid." ORDER BY name ASC ";
													...
													{
														global $conn;
														$query = "SELECT * FROM category AS c WHERE c.parentid = 0 ORDER BY name ASC";
							...
							<div class="col-sm-2 ">
								<div class="form-group">
									<label>Tip popusta</label>
									<select  name="newVoucherType" class="form-control jq_newVoucherTypeDiscountCategory" required="required">
												<option value="P">Popust izrazen u procentima</option>
												<option value="T">Totalni popust</option>
												<option value="I">Individualni popust</option>
									</select>
                     	...
                     	<div class="row " style="background: rgb(248, 255, 208);  margin-right: 0px;  margin-left: 0px;">
                     		<div class="col-sm-8 ">
								<div class="form-group">
									...
									<div class="col-sm-2 ">
											<label>Tip popusta</label>
											<select  name="newVoucherType" class="form-control jq_newVoucherTypeDiscountProduct" required="required">
												<option value="P">Popust izrazen u procentima</option>
												<option value="T">Totalni popust</option>
												<option value="I">Individualni popust</option>
											</select>
