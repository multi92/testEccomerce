...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>';
    ...
    $email_msg.='<span class="preheader"></span>
          ...
          $email_msg.=''; 
              ...
              $email_msg.=' <table class="attributes" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            ...
                            '. $emailOrderRecipientData.'<br /><br /><br />
                         </span>
                                  </td>
                                
                                  <td width="33%" class="attributes_item">
                                    <span class="f-fallback">
                            '.$emailOrderDeliveryData.'<br /><br /><br />
                         </span>
                                  </td>
                        ...
                        <table class="purchase" width="1000px" cellpadding="0" cellspacing="0">
                          <tr>
                            <td colspan="2">
                              <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                  ...
                                  <th class="purchase_heading" align="left">
                                    <p class="f-fallback">Popust</p>
                                  </th>
                                  <th class="purchase_heading" align="left">
                                    <p class="f-fallback">Cena</p>
                                  </th>
                                  <th class="purchase_heading" align="left">
                                    <p class="f-fallback">Cena sa PDV-om</p>
                                  </th>
                                  <th class="purchase_heading" align="right">
                                    <p class="f-fallback">Ukupno</p>
                                  </th>
                                </tr>';
                                foreach ($orderItems as $key => $orderItem) {
                                 $email_msg.='<tr style="border-bottom:1px solid #cccccc;">';
                                  	 ...
                                  	 $email_msg.='<td width="10%" class="purchase_item"><span class="f-fallback">'.number_format($orderItem["item_rebate"],2).'%</span></td>';
                                  	 $email_msg.='<td width="10%" class="purchase_item"><span class="f-fallback">'.number_format($orderItem["pricewithrebate"],2).'</span></td>';
                                     $email_msg.='<td width="10%" class="purchase_item"><span class="f-fallback">'.number_format($orderItem["pricewithrebatewithvat"],2).'</span></td>';
                                  	 $email_msg.='<td width="20%" class="purchase_item align-right" align="right" ><span class="f-fallback">'.number_format($orderItem["itemvaluewithvat"],2).'</span></td>';
                                 $email_msg.='</tr>';
                                }
                           ...
                           $email_msg.='<table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">';
                                ...
                                $email_msg.='<tr>
                                  				<td width="80%" class="purchase_footer" valign="middle">
                                  				  <p class="f-fallback purchase_total purchase_total--label">Iznos vaučera: </p>
                                  				</td>
                                  				<td width="20%" class="purchase_footer" valign="middle" style="text-align:right;">
                                  				  <p class="f-fallback purchase_total">-'.number_format(round($voucher_value,2), 2, ",", ".").'</p>
                                  				</td>
                                			</tr>';
                                }
*/
