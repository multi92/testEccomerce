...
/**/
            ...
            case "f":
                ...
                <div class="container">
                    <h3 class="bigmessage">VAŠA PORUDŽBINA JE PRIHVAĆENA!<br ></h3>      
            ...
            case "s":
                ...
                <div class="container">
                    <h3 class="bigmessage">VAŠA PORUDŽBINA JE POSLATA!<br >Vaš kod za praćenje pošiljke je:'.$drow['deliverycode'].' </h3>      
            ...
            case "d":
                ...
                <div class="container">
                    <h3 class="bigmessage">VAŠA PORUDŽBINA '.$order_number.' JE ODBIJENA!</h3>  
                    <p class="infoemail_text">Poštovani '.$drow['customername'].', </p>
        ...
        $orderDetailData .= "<br /><br /><br />";

        $emailOrderCustomerData  ="<br /> Detalji naručioca: <br />";
        $emailOrderCustomerData .= "<br />Email:  ".$drow['customeremail'];
        $emailOrderCustomerData .= "<br />Ime : ".$drow['customername'];
        $emailOrderCustomerData .= "<br />Prezime : ".$drow['customerlastname'];
        $emailOrderCustomerData .= "<br />Telefon : ".$drow['customerphone'];
        $emailOrderCustomerData .= "<br />Adresa : ".$drow['customeraddress'].", ".$drow['customerzip']." , ".$drow['customercity'];
        $emailOrderCustomerData .= "<br /><br /><br />";


        $emailOrderRecipientData="<br /> Podaci za dostavu: <br />";
        $emailOrderRecipientData .= "<br />Ime : ".$drow['recipientname'];
        $emailOrderRecipientData .= "<br />Prezime : ".$drow['recipientlastname'];
        $emailOrderRecipientData .= "<br />Telefon : ".$drow['recipientphone'];
        $emailOrderRecipientData .= "<br />Adresa : ".$drow['recipientaddress'].", ".$drow['recipientzip']." , ".$drow['recipientcity'];
        ...
        if( 
           $drow['recipientname'] !='' && 
           $drow['recipientlastname'] !='' && 
           $drow['recipientphone'] !='' && 
           $drow['recipientaddress'] !='' && 
           $drow['recipientzip'] !='' &&
           $drow['recipientcity']!='' ){
        ...
        switch ($deliveryType) {
            ...
            case "d":
                ...
                if(strlen($deliveryServiceData['deliverytracklink'])>0 && strlen($drow['deliverycode'])>0){
                    $deliveryData .= "<b>Pošiljku možete pratiti na sledećem linku: ".$deliveryServiceData['deliverytracklink']."</b><br/>";
                    $deliveryData .= "<b>Vaš kod za praćenje pošiljke je: ".$drow['deliverycode']."</b><br/>";  
                }
                break;
            case "h":
                $deliveryData="";
        ...
        if(isset($dataItems) && is_array($dataItems) && count($dataItems)>0){
            ...
            foreach ($orderItems as $key => $cartprod) {
                ...
                //PRODUCT PRICE END
                $orderItems[$key]['picture'] = $productImagesData[0]['img'];
                //ATRIBUTES
                $attrs = array();
                ...
                $orderItems[$key]['pricewithrebatewithvat'] = $cartprod['price']*(1-($calc_itemRebate/100))*((100+$cartprod['tax'])/100);
        ...
        $delivery_cost=0; 
        if(floatval($calc_totalValueWithRebateWithVat-floatval($drow['couponvalue']))>$user_conf["free_delivery_from"][1]){
            $delivery_cost=0;
        } else {
    ...
    function generate_pdf_bill($oid){
        ...
        $msg = '<html>
                    ...
                    <body>';
                        ...
                        $msg .= '<div class="treethirds">
                                            <img style="width: 100%;left: 0;" src="../../../../'.$user_conf["memorandum_logo"][1].'" />
                                        </div>';
                        ...
                        $msg .= '<div class="x_half" style="width:50%; float:left; font-size:12px!important; line-height:14px">
                            <br>
                            <br>
    ...
    function get_b2c_header($type, $info){
        ...
        if($type == 2){
            ...
            $smallmessage = '<p class="infoemail_text">Poštovani '.$info['name'].', </p>
                            <p class="infoemail_text">Želimo da Vam se zahvalimo na Vašoj kupovini, Vaša porudžbina je u obradi. <br >
                            O toku obrade bićete informisani putem e-mail poruke.</p>';
        }
        
        if($type == 3){
            $bigmessage = 'VAŠA PORUDŽBINA JE OBRADJENA!';
            $smallmessage = '<p class="infoemail_text">POŠTOVANI '.strtoupper($info['name']).', </p>
                            <p class="infoemail_text">NAKON FINALNE PROVERE PROIZVODA KOJE STE PORUČILI <br >
DOBIĆETE KONAČNU POTVRDU DA JE VAŠA PORUDŽBINA <br >
PRIHVAĆENA I POSLATA , KAO I BROJ ZA PRAĆENJE VAŠE PORUDŽBINE .</p>';
        }
        
        if($type == 4){
            $bigmessage = 'VAŠA PORUDŽBINA JE DELIMIČNO PRIHVAĆENA!';
            $smallmessage = '<p class="infoemail_text">Poštovani '.$info['name'].', </p>
                            <p class="infoemail_text">
                                Vašu porudžbinu ne možemo u potpunosti isporučiti! <br /> <br /> 
                                U nastavku ove poruke se nalazi vaša porudžbina sa obeleženim stavkama koje nismo u mogućnosti da vam isporučimo. <br /><br />  
        ...
        if($type == 5){
            ...
            $bigmessage = 'VAŠA PORUDŽBINA JE POSLATA!';
            $smallmessage = '<p class="infoemail_text">
                                Poštovani '.$info['name'].', </p>
                                <p class="infoemail_text">Vaša porudžbina je dostavljena kurirskoj službi CityExpress!</p>
        ...
        if($type == 6){
            $bigmessage = 'VAŠA PORUDŽBINA JE ODBIJENA!';
            $smallmessage = '<p class="infoemail_text">Poštovani '.$info['name'].', </p>
                            <p class="infoemail_text">Vašu porudžbinu ne možemo isporučiti!</p>';
        }
    ...
    function get_b2c_info($orderid, $dev = false){
        ...
        $data = '<div class="container-fluid orderdetailcont">
                    <div class="container orderdetailholder">
                        <div class="half">
                            <h1 class="smalltitle">Detalji porudžbine</h1>
                            <hr class="smallline"><div class="clear"></div>
                        
                            <p class="infoline"><span>Broj porudzbine:</span> '.$drow['number'].' </p>
                            <p class="infoline"><span>Datum porudzbine:</span> '.date('d.m.Y H:i:s', strtotime($drow['documentdate'])).' </p>
