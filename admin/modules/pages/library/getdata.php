<?php
	 ...
	 */
	 //var_dump($_POST['search']['value']);
		...
		if ( $_POST['search']['value'] != "" )
		{
			...
			{
				$sWhere .= "p.".$aColumns[$i]." LIKE '%".mysqli_real_escape_string($conn, $_POST['search']['value'] )."%' OR ";
			}
	...
	$sQuery = "	
		SELECT SQL_CALC_FOUND_ROWS p.id, p.name, p.adddate, p.changedate, p.status, CONCAT(u.name,' ',u.surname) as owner
		FROM pages as p
