 	...
 	<section class="content">
         ...
         <div class="row">
             <div class="col-sm-12 verticalMargin10">
                 ...
                 <button class="btn btn-primary" id="addButton">Nova usluga</button>
                 <?php endif;?>
                 <button class="btn btn-primary" id="listButton">Lista usluga</button>
             </div>
         </div>
             ...
             <div class="col-xs-12">
               ...
               <div class="box">
                 <div class="box-header">
                   <h3 class="box-title">Lista svih usluga u bazi</h3>
                 </div><!-- /.box-header -->
                 <div class="box-body">
