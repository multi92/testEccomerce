...
$(document).ready(function (e) {
	$("#listtable").DataTable({
        ...
        "language": {
				...
				"info":           "Prikaz _START_ do _END_ od _TOTAL_ usluge",
				"infoEmpty":      "Prikaz 0 do 0 od 0 usluga",
				"infoFiltered":   "(filtrirano od _MAX_ usluga)",
				"infoPostFix":    "",
				"thousands":      ",",
				"lengthMenu":     "Prikazi _MENU_ usluga",
