<?php
ini_set('open_basedir', $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR);
...
class fs
{
	...
	public function lst($id, $with_root = false) {
		...
		$res = array();
		foreach($lst as $item) {
			if($item == '.' || $item == '..' || $item == 'big' || $item == 'small' || $item == 'medium' || $item == 'medium '  || $item == 'thumb' || $item === null) { continue; }
...
if(isset($_GET['operation'])) {
	...
	$fs = new fs($_SERVER['DOCUMENT_ROOT'].'/'.$subdirname.'/fajlovi/');
	try {
		$rslt = null;
