 <div class="content-wrapper" currentview='home'>
 	<section class="content-header -breadcrumbColor">
 		<h1>
 			<i class="fa fa-cogs"></i> Učitani brendovi
 		</h1>
 		<ol class="breadcrumb">
 			<li><a href="dashboard"><i class="fa fa-dashboard"></i> Početna </a></li>
 			<li class="active"><i class="fa fa-cogs"></i> Učitani brendovi </li>
 		</ol>
 	</section>
 	<!-- Main content -->
 	<section class="content">
         ...
         <div class="row">
             <div class="col-sm-12 verticalMargin10">
                 <button class="btn btn-primary" id="listButton">Lista učitanih brendova</button>
             </div>
         </div>
             ...
             <div class="col-xs-12">
               ...
               <div class="box">
                 <div class="box-header">
                   <h3 class="box-title">Lista svih učitanih brendova u bazi</h3>
                   <div class="row">
                    	<div class="col-sm-1">
                           <div class="checkbox">
                                <label>Povezani</label>
                                <select class="jq_connectedBrendSearchCont form-control">
