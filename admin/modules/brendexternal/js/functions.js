...
function updateLocalBrend(elem){
	var localbrendid = $(elem).val();
	var id = $(elem).parents('tr').find('.addLocalBrendButton').attr('id');
	
	/*	objecty to pass	 */
	var passdata = {action: "updatelocalbrend",
					id: id,
					localbrendid : localbrendid
					};
...
function addLocalBrend(elem){
	var id = $(elem).attr('id');
	
	/*	objecty to pass	 */
	var passdata = {action: "addlocalbrend",
					id: id
					};
