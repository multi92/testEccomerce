<?php
	 ...
	 */
	$aColumns = array(  'id', 'name', 'code', 'address', 'email', 'partnertype', 'active' );
	...
	$sQuery = "	
		SELECT SQL_CALC_FOUND_ROWS p.id, p.name, p.code, p.address, p.email, p.partnertype, p.sort, p.active, CONCAT(u.name,' ',u.surname) as `responsibleperson`
		FROM  partner as p
