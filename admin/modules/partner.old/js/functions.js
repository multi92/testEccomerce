        ...
        "ajax":{
				...
				dataSrc: function(a){
					...
					if(a.aaData[i][97]>0){
						...
						{
							var infoBTN = '<button class="btn btn-primary userInfoBTN hide" userid="'+a.aaData[i][97]+'">Info. o korisniku</button> ';
						}
					}
					var createPartnerBTN = '<button class="btn btn-warning disabled " disabled="disabled">Odobri partnerski nalog</button> ';
					
					if(a.aaData[i][98]==0 || a.aaData[i][98]=='NULL' || a.aaData[i][98]=='' || a.aaData[i][98]=='0'){
					...
					// }
					a.aaData[i][13] = '' ;
					a.aaData[i][14] = infoBTN +'<br>'+createPartnerBTN;
